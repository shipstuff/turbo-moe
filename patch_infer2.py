#!/usr/bin/env python3
"""Patch infer.m with TurboQuant integration."""
...
c4_old = """        ctx->buf_attn_gate   = [ctx->device newBufferWithLength:NUM_ATTN_HEADS * HEAD_DIM * sizeof(float)
        ...
        printf("[metal] GPU attention buffers:"""
...
# CHANGE 6: Add TurboQuant dispatch before Enc A1
...
# CHANGE 7: Close else after attn_values
